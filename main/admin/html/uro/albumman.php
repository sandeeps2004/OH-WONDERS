...
<body class="page-body" data-url="http://neon.dev">
        ...
        <tbody>
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo "<img src= al_image/".$row['ALBUM_IMAGE']." height='75px'>";?></td>
                            <td><?php echo $row['ALS_LINK']; ?></td><td><?php echo $row['ALY_LINK']; ?></td>
                            <td>


                                <a href="?del=<?php echo $row['ALBUM_ID']; ?>" onclick="return confirm('Are You Sure You Want to Delete This Record?');"><button class="btn btn-danger btn-sm btn-icon icon-left">
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE album_table SET STATUS= '1' WHERE ALBUM_ID =".$_GET['del']."";
        // $query = "UPDATE login_table SET L_ID =".$_GET['del']." WHERE 1";
        $res = mysqli_query($con, $query);
        if ($res) {
            if (!isset($_GET['reload'])) {
                $_SESSION['ohwonder'] = $lemail;
                echo '<meta http-equiv=Refresh content="0;url=albumman.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
