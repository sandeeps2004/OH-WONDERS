...
<body class="page-body" data-url="http://neon.dev">
    ...
    <table class="table table-bordered datatable" id="table">
        ...
        <tbody>
            ...
            if ($con) {
                ...
                if ($db) {
                    $sql = "SELECT * FROM merch_table where STATUS=0";
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td><?php echo "<img src= m_image/".$row['PHOTO']." height='75px'>";?></td>
                            ...
                            <td>
                                ...
                                <a href="?del=<?php echo $row['MERCH_ID']; ?>" onclick="return confirm('Are You Sure You Want to Delete This Record?');"><button class="btn btn-danger btn-sm btn-icon icon-left">
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE merch_table SET STATUS= '1' WHERE MERCH_ID =".$_GET['del']."";
        // $query = "UPDATE login_table SET L_ID =".$_GET['del']." WHERE 1";
        $res = mysqli_query($con, $query);
        if ($res) {
            if (!isset($_GET['reload'])) {
                $_SESSION['ohwonder'] = $lemail;
                echo '<meta http-equiv=Refresh content="0;url=merchman.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
