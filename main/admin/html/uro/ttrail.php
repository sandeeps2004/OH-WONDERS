...
<body class="page-body" data-url="http://neon.dev">
    ...
    <table class="table table-bordered datatable" id="table">
        ...
        <tbody>
            ...
            if ($con) {
                ...
                if ($db) {
                    $sql = "SELECT * FROM login_table where STATUS=0 AND role=1 ORDER BY `DATE` DESC";
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="?del=<?php echo $row['L_ID']; ?>" onclick="return confirm('Are You Sure You Want to Delete This Record?');"><button class="btn btn-danger btn-sm btn-icon icon-left">
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE login_table SET STATUS= '1' WHERE L_ID =".$_GET['del']."";
        // $query = "UPDATE login_table SET L_ID =".$_GET['del']." WHERE 1";
        $res = mysqli_query($con, $query);
        if ($res) {
            if (!isset($_GET['reload'])) {
                $_SESSION['ohwonder'] = $lemail;
                echo '<meta http-equiv=Refresh content="0;url=ttrail.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
