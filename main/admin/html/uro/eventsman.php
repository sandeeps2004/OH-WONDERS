...
<body class="page-body" data-url="http://neon.dev">
        ...
        <tbody>
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                            <?php echo "<img src= e_image/".$row['EVENT_IMG']." height='75px'>";?>
                            </td>
                            <td><?php echo $row['VENUE_DETAILS'];?></td>
                            <td><?php echo $row['EVENT_DATE'];  echo"&emsp; <b>TIME:</b>";  echo $row['EVENT_TIME'];?></td>
                            <td><?php echo $row['EVENT_LINK'];?></td>
                            <td>
                                

                                <a href="?del=<?php echo $row['EVENT_ID']; ?>" onclick="return confirm('Are You Sure You Want to Delete This Record?');"><button class="btn btn-danger btn-sm btn-icon icon-left">
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE events_table SET EVENT_STATUS= '1' WHERE EVENT_ID=".$_GET['del']."";
        // $query = "UPDATE login_table SET L_ID =".$_GET['del']." WHERE 1";
        $res = mysqli_query($con, $query);
        if ($res) {
            if (!isset($_GET['reload'])) {
                $_SESSION['ohwonder'] = $lemail;
                echo '<meta http-equiv=Refresh content="0;url=eventsman.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
