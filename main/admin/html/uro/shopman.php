...
<body class="page-body" data-url="http://neon.dev">
        ...
        <tbody>
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                            <?php echo "<img src= m_image/".$row['product_image']." height='75px'>";?>
                            </td>
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE product SET STATUS= '1' WHERE id=".$_GET['del']."";
        ...
        if ($res) {
            if (!isset($_GET['reload'])) {
                ...
                echo '<meta http-equiv=Refresh content="0;url=shopman.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
