...
<body class="page-body" data-url="http://neon.dev">
    ...
    <ol class="breadcrumb bc-3">
        ...
        <li>
            ...
            <a href="checkfeedback.php">Tables</a>
        </li>
        <li class="active">
    ...
    <table class="table table-bordered datatable" id="table">
        ...
        <tbody>
            ...
            if ($con) {
                ...
                if ($db) {
                    $sql = "SELECT * FROM contactus_table WHERE STATUS=0 ";
            ...
            ?>
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="?del=<?php echo $row['FEED_ID']; ?>" onclick="return confirm('Are You Sure You Want to Delete This Record?');"><button class="btn btn-danger btn-sm btn-icon icon-left">
    ...
    <?php
    if (isset($_GET['del'])) {
        $query = "UPDATE `contactus_table` SET STATUS= '1' WHERE FEED_ID =".$_GET['del']."";
        // $query = "UPDATE login_table SET L_ID =".$_GET['del']." WHERE 1";
        $res = mysqli_query($con, $query);
        if ($res) {
            if (!isset($_GET['reload'])) {
                $_SESSION['ohwonder'] = $lemail;
                echo '<meta http-equiv=Refresh content="0;url=checkfeedback.php?reload=1">';
                // echo"DELEtED";
            }
        }
    }
