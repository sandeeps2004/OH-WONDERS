...
<body>
	...
	<div class="logo-container">
		<center><a href="\projectmusic1/main/home.php"><img src="images/ohmainlogo1.png" class="logo" width="250px"></a></center>
	</div>
	<div class="section">
		<div class="container">
	...
	if (isset($_POST['rsubmit'])) {
		...
		$a = date('Y-m-d H:i:s');
		$check_email = mysqli_query($con, "SELECT EMAIL_ID FROM login_table where EMAIL_ID = '$email' ");
		if (mysqli_num_rows($check_email) > 0) {
			...
			if ($p1 == $p2) {
				...
				if ($sql) {
					echo 'Registered Succesfully<br> Go to Login Page<br>';
					$query = "INSERT INTO login_table SET STATUS = '1' WHERE L_ID = " . $_POST['rsubmit'] . "";
				} else {
	...
	if (isset($_POST['lsubmit'])) {
		...
		if ($count == 1) {
			...
			if (!isset($_GET['reload'])) {
				echo '<meta http-equiv=Refresh content="0;url=home.php?reload=1">';
			}
			else{
			...
			if($sql1="SELECT * FROM login_table WHERE EMAIL_ID='".$aemail."' AND PASSWORD='".$apass."' AND ROLE=0 AND STATUS=1"){
